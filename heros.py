...
#1.The purchase count and percentage of players ins more for ages 20-24 and less for 40 puls age people and below 10 yrs kis which shows age factor matters in the game
#2.Majority of people i.e., almost 84% of them are males and females are very less i.e., 14% compared to the males
#3.in the last result table i found that the item price for most profitable items and less profitable items is just some cents difference but not huge difference
